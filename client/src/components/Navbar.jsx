    ...
    <div className='flex item-center justify-between py-4 '>
     ...
     <div>
        ...
        <div className='flex item-center gap-2 sm:gap-5'>
            ...
            <button onClick={()=>setShowLogin(true)}className='bg-zinc-800 text-white px-7 py-2 sm:px-10 text-sm rounded-full hover:scale-105 transition-all duration-700 drop-shadow'>Login</button>
        </div>
        }
